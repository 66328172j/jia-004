...
-- 检验批批量导入菜单与按钮权限（jia-004 批量导入）
INSERT INTO `t_sys_permission` VALUES
 (930000000000000060, '批量导入', '检验批批量导入记录展示', '/SampImportController/view', 0, 930000000000000001, 'system:sampImport:view', 1, 'layui-icon layui-icon-upload', 8, 0, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000061, '导入批次集合', '导入批次集合', '/SampImportController/list', 0, 930000000000000060, 'system:sampImport:list', 2, '', NULL, 0, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000062, '批量导入', '批量导入', '/SampImportController/import', 0, 930000000000000060, 'system:sampImport:import', 2, 'layui-icon layui-icon-upload', NULL, 0, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000063, '失败明细下载', '失败明细下载', '/SampImportController/downloadError', 0, 930000000000000060, 'system:sampImport:downloadError', 2, 'layui-icon layui-icon-download-circle', NULL, 0, 'admin', sysdate(), NULL, NULL, NULL);

-- 授权给管理员角色（488243256161730560）
INSERT INTO `t_sys_permission_role` VALUES
 (930000000000000160, 488243256161730560, 930000000000000060, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000161, 488243256161730560, 930000000000000061, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000162, 488243256161730560, 930000000000000062, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000163, 488243256161730560, 930000000000000063, 'admin', sysdate(), NULL, NULL, NULL);

-- 移动端扫码查询记录菜单与按钮权限（jia-004 客户扫码查询）
-- 客户扫码页 /SampScanController/view 与查询接口 /SampScanController/query 为匿名访问，不配置菜单权限
INSERT INTO `t_sys_permission` VALUES
 (930000000000000070, '扫码查询记录', '移动端扫码查询记录展示', '/SampScanController/logView', 0, 930000000000000001, 'system:sampQueryLog:view', 1, 'layui-icon layui-icon-cellphone', 9, 0, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000071, '查询记录集合', '查询记录集合', '/SampScanController/logList', 0, 930000000000000070, 'system:sampQueryLog:list', 2, '', NULL, 0, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000072, '查询记录删除', '查询记录删除', '/SampScanController/logRemove', 0, 930000000000000070, 'system:sampQueryLog:remove', 2, 'layui-icon layui-icon-delete', NULL, 0, 'admin', sysdate(), NULL, NULL, NULL);

-- 授权给管理员角色（488243256161730560）
INSERT INTO `t_sys_permission_role` VALUES
 (930000000000000170, 488243256161730560, 930000000000000070, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000171, 488243256161730560, 930000000000000071, 'admin', sysdate(), NULL, NULL, NULL),
 (930000000000000172, 488243256161730560, 930000000000000072, 'admin', sysdate(), NULL, NULL, NULL);
